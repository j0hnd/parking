...
Route::get('/airport', 'ParkingAppController@airport_page');
Route::get('/landing/{airport_name}', 'ParkingAppController@landing_page');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/product/toggle', 'ProductsController@toggle');
