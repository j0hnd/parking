 ...
 <div id="mobileNav" class="overlay-nav">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 contact-card">
                <div class="row">
                    <div class="col-md-12">
                        <p class="contact-head">Social</p>
                        <br/>
                        <p class="con-content">Follow us for quick updates and links on our very own social media pages. Additionally, use these to get in touch with us: </p>
                        <br/>
                        ...
                        <br/>
                        <p class="con-content">If you're looking to try our app, but want to talk to us first you can go ahead and chat live with us by this following link:</p>
                        <br/>
                        <br/>
