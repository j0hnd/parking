			...
			<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					...
					<td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
						...
						<a class="button-a button-a-primary" href="https://play.google.com/store?hl=en" style="background: #222222; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;">Download App Now!</a>
					</td>
					<!-- Column : END -->
				</tr>
			</table>
				...
				<tr>
					...
					<td class="stack-column-center">
						<table role="presentation" cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td style="padding: 10px; text-align: center">
									<img src="https://mytravelcompared.com/img/email-your-details.jpg" width="270" height="60" alt="alt_text" border="0" class="fluid" style="height: auto; line-height: 15px;">
								</td>
							</tr>
							<tr>
								<td style="font-family: sans-serif; font-size: 12px; color: #555555;line-height: 20px; text-align: left;" class="center-on-narrow">
				...
				<tr>
					...
					<td class="stack-column-center" valign="top">
						<table role="presentation" cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td style="padding: 10px; text-align: center">
									<img src="https://mytravelcompared.com/img/email-your-journey.jpg" width="270" height="60" alt="alt_text" border="0" class="fluid" style="height: auto; line-height: 15px;">
								</td>
							</tr>
							<tr>
								<td style="font-family: sans-serif; font-size: 12px; color: #555555;line-height: 20px; text-align: left;" class="center-on-narrow">
