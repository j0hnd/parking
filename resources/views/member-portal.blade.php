...
<body style="background-color: #666666;">
    ...
    <script src="{{ asset('/member-portal/vendor/counter-up/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('/member-portal/vendor/counter-up/jquery.counterup.min.js') }}">
    </script>
